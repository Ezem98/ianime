          ...
          ? data?.slice(0, 5).map((anime, index) => {
              return (
                <article
                  ...
                  key={index}
                  className="flex flex-col flex-grow w-0 h-full opacity-80 relative transition-all hover:cursor-crosshair hover:w-[600px] hover:opacity-1 hover:contrast-120"
                >
                  <img
